...
protocol SimilarTvCVCDelegate: AnyObject {
    func seeMoreSimilar()
    func showMovieDetail(for cell: SimilarTvCVC, at indexPath: IndexPath)
}

class SimilarTvCVC: BaseCollectionViewCell {
    @IBOutlet weak var collectionView: UICollectionView!
    
    weak var delegate: SimilarTvCVCDelegate?
...
extension SimilarTvCVC: UICollectionViewDataSource {
...
extension SimilarTvCVC: UICollectionViewDelegate {
    
}

extension SimilarTvCVC: UICollectionViewDelegateFlowLayout {
